...
This document describes the classes in the **JadeMockSchema** which implement the Jade Mocking Framework.
...
#### zMockedParameterValueTypes : ObjectArray protected

Types of the values to use to mock updates to Usage IO or Usage Output parameters.

#### zMockedParameterValues : ObjectArray protected
...
The parameters of this JadeMockCallInstance instance.
